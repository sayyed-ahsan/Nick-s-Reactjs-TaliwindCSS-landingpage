  ...
  return (
    <div className="mx-auto max-w-[1120px]  px-[24px] sm:px-0 mt-[100px] mb-[100px]">
      ...
      <div className="flex max-w-[624px] mx-auto bg-[#EDEDED] p-[12px] rounded-[32px] mb-[25px] mt-[40px]">
        <div
          className={`cursor-pointer max-w-[300px] w-full flex items-center justify-center rounded-[16px] p-[22px] ${
            show && "bg-white"
          }`}
        ...
        <div
          className={`cursor-pointer max-w-[300px] w-full flex items-center justify-center rounded-[16px] p-[24px] ${
            !show && "bg-white"
          }`}
          onClick={() => setShow(!show)}
        >

            ...
            <div className='flex flex-wrap items-center justify-between gap-[24px]'>
                <div className='max-w-[357px] w-full mx-auto p-[24px] rounded-[16px] border-[1px] border-[#BABABA]'>
                    ...
                    <div className='flex items-center gap-[8px]'>
                        <img src={tikMark} alt="" />
                        <p className='text-[#7B7B7B] text-[16px]'>Up to 300 Monthly Orders</p>
                    </div>
                    <div className='flex items-center gap-[8px]'>
                        <img src={tikMark} alt="" />
                        <p className='text-[#7B7B7B] text-[16px]'>Amazon Custom and Handmade</p>
                    </div>
                    <div className='flex items-center gap-[8px]'>
                        <img src={tikMark} alt="" />
                        <p className='text-[#7B7B7B] text-[16px]'>Highly Customizable Display</p>
                    </div>
                    <button className='text-[16px] font-bold py-[8px] w-full mt-[24px] border-[1px] border-[#F29E13] rounded-[32px]'>
                        Get Started
                    </button>
                </div>
                <div style={{ boxShadow: '0px 0px 13px #BABABA' }} className='max-w-[357px] w-full mx-auto p-[24px] rounded-[16px]'>
                    <p className='text-[#1387F2] bg-[#E6F3FF] font-bold py-[4px] px-[12px] rounded-[32px] inline-block mb-5px'>Most Popular</p>
